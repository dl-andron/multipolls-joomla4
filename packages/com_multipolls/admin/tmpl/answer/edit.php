...
/** @var \DL\Component\Multipolls\Administrator\View\Answer\HtmlView $this */
...
<form action="<?php echo Route::_('index.php?option=com_multipolls&layout=edit&id=' . (int) $this->item->id); ?>"
      ...
      aria-label="<?php echo Text::_('COM_MULTIPOLLS_ANSWER_FORM_TITLE_' . ((int) $this->item->id === 0 ? 'NEW' : 'EDIT'), true); ?>"
      class="form-validate">
    ...
    <div class="main-card">
	    ...
	    <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'details', Text::_('COM_MULTIPOLLS_ANSWER_TAB')); ?>
        <div class="row">
            <div class="col-md-12">
