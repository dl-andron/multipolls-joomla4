...
<form action="<?php echo Route::_('index.php?option=com_multipolls&view=answers'); ?>" method="post" name="adminForm" id="adminForm">
	<div class="row">
		<div class="col-md-12">
			<div id="j-main-container" class="j-main-container">
				...
				<?php else : ?>
                    <table class="table itemList" id="answerList">
                        <caption class="visually-hidden">
		                    <?php echo Text::_('COM_MULTIPOLLS_ANSWERS_TABLE_CAPTION'); ?>,
                        ...
                        <tbody>
                            ...
                            <tr class="row<?php echo $i % 2; ?>">
                                ...
                                <td class="text-center">
		                            <?php echo HTMLHelper::_('jgrid.published', $item->published, $i, 'answers.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
                                </td>
                                <th scope="row">
                                    <div class="break-word">
		                                <?php if ($canEdit) : ?>
                                            <a href="<?php echo Route::_('index.php?option=com_multipolls&task=answer.edit&id=' . (int) $item->id); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?> <?php echo $this->escape($item->name); ?>">
                                    ...
                                    <div class="small">
		                                <?php echo Text::_('COM_MULTIPOLLS_QUESTION') . ': '; ?>
		                                <?php if ($canEdit) : ?>
                                            <a href="<?php echo Route::_('index.php?option=com_multipolls&task=question.edit&id=' . (int) $item->id_question); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?> <?php echo $this->escape($item->question_name); ?>">
				                                <?php echo $this->escape($item->question_name); ?></a>
		                                <?php else : ?>
			                                <?php echo $this->escape($item->question_name); ?>
		                                <?php endif; ?>
                                    </div>
                                    <div class="small">
					...
					<?php if (
						...
						<?php echo HTMLHelper::_(
							...
							'collapseModal',
							[
								'title' => Text::_('COM_MULTIPOLLS_ANSWERS_BATCH_OPTIONS'),
