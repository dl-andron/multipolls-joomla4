...
namespace DL\Component\Multipolls\Administrator\View\Polls;
	...
	protected function addToolbar(): void
	{
		...
		if (!$this->isEmptyState && $canDo->get('core.edit.state')) {
			...
			if ($canDo->get('core.edit.state')) {
				$childBar->publish('polls.publish')->listCheck(true);

				$childBar->unpublish('polls.unpublish')->listCheck(true);
			}
		}

		if (!$this->isEmptyState && $canDo->get('core.delete')) {
			$toolbar->delete('polls.delete')
