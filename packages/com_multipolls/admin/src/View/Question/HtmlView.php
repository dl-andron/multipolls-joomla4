...
namespace DL\Component\Multipolls\Administrator\View\Question;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		ToolbarHelper::title(
			$isNew ? Text::_('COM_MULTIPOLLS_QUESTION_NEW') : Text::_('COM_MULTIPOLLS_QUESTION_EDIT'),
			'copy'
		);
		...
		if ($canDo->get('core.edit') || \count($user->getAuthorisedCategories('com_multipolls', 'core.create')) > 0) {
			...
			$toolbarButtons[] = ['save', 'question.save'];

			if ($canDo->get('core.create')) {
				$toolbarButtons[] = ['save2new', 'question.save2new'];
			}
		}
