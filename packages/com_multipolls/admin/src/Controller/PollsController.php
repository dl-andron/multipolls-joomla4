...
class PollsController extends AdminController
{
	 ...
	 *
	 */
	public function getModel($name = 'Poll', $prefix = 'Administrator', $config = array('ignore_request' => true))
	{
	...
	{
		$questionModel = $this->getModel('Question', '', array());
		$questionModel->postPollsDeleteHook($id);
	}
}